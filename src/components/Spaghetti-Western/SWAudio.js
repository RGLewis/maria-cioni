...
class SWAudio extends Component {
    constructor() {
        super()
    ...
    render() {
        const audioToggleBar = this.state.audioIsShown ? "hide-show-bar vertical vertical-to-horizontal" : "hide-show-bar vertical";
                ...
                <div className="heading-container">
                    ...
                    <div className="hide-show-button-container">
                        <button
                            ...
                            onClick={this.handleAudioToggled}
                        >
